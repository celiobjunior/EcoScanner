...
enum LocalizationStore {
    ...
    static let en: [String: String] = [
        ...
        "onboarding.page1.subtitle": "EcoScanner is a material-detection app designed to encourage correct selective disposal every day.",
        "onboarding.page1.card1.title": "What the app does",
        "onboarding.page1.card1.body": "Use the camera to identify an object's material and get disposal guidance.",
        "onboarding.page1.card2.title": "Environmental goal",
        "onboarding.page1.card2.body": "By logging each action, you build habit and prevent recyclables from going to regular trash.",
        "onboarding.page2.title": "Scan first,\nthen discard",
        "onboarding.page2.subtitle": "Point the camera at the object, check the detected category, then discard it in the correct stream.",
        "onboarding.page2.card1.title": "Step 1: point and scan",
        "onboarding.page2.card1.body": "Frame a single object in the camera and tap scan.",
        "onboarding.page2.card2.title": "Step 2: discard correctly",
        "onboarding.page2.card2.body": "With the category identified, discard it in the proper bin and log it in the app.",
        ...
        // Guided first scan
        "guided.scan.title": "Tutorial: first scan",
        "guided.scan.body": "Point the camera at an object, scan it, then discard it in the correct stream.",
        ...
        "credits.thanks": "Thanks for using",
        "credits.intro": "Built for the Apple Swift Student Challenge. EcoScanner uses open resources and community contributions. Special thanks to the sources below.",
        ...
        "credits.dataset.1.title": "Garbage Classification v2",
        "credits.dataset.1.detail": "Kaggle dataset by sumn2u",
        "credits.dataset.2.title": "Garbage Classification",
        "credits.dataset.2.detail": "Kaggle dataset by asdasdasasdas",
        "credits.dataset.3.title": "Garbage Classification",
        "credits.dataset.3.detail": "Kaggle dataset by mostafaabla",
        "credits.dataset.4.title": "Plastic Paper Garbage Bag",
        "credits.dataset.4.detail": "Synthetic Images by vencerlanz09",
        "credits.dataset.5.title": "Trash Type Image Dataset",
        "credits.dataset.5.detail": "Kaggle dataset by farzadnekouei",
        "credits.dataset.6.title": "Garbage Classification",
        "credits.dataset.6.detail": "Kaggle dataset by hassnainzaidi",
        "credits.dataset.7.title": "Tipe Webscraping",
        "credits.dataset.7.detail": "Kaggle dataset by manonstr",
    ...
    static let ptBR: [String: String] = [
        ...
        "onboarding.page1.subtitle": "EcoScanner é um app de detecção de materiais para incentivar o descarte seletivo correto todos os dias.",
        "onboarding.page1.card1.title": "O que o app faz",
        "onboarding.page1.card1.body": "Use a câmera para identificar o material de um objeto e receber orientação de descarte.",
        "onboarding.page1.card2.title": "Objetivo ambiental",
        "onboarding.page1.card2.body": "Ao registrar cada ação, você cria hábito e evita que recicláveis vão para o lixo comum.",
        "onboarding.page2.title": "Escaneie primeiro,\ndepois descarte",
        "onboarding.page2.subtitle": "Aponte a câmera para o objeto, veja a categoria detectada e depois descarte no fluxo correto.",
        "onboarding.page2.card1.title": "Passo 1: apontar e escanear",
        "onboarding.page2.card1.body": "Enquadre um único objeto na câmera e toque em escanear.",
        "onboarding.page2.card2.title": "Passo 2: descartar corretamente",
        "onboarding.page2.card2.body": "Com a categoria identificada, descarte no recipiente adequado e registre no app.",
        ...
        "guided.scan.title": "Tutorial: primeiro scan",
        "guided.scan.body": "Aponte a câmera para um objeto, faça o scan e depois descarte no fluxo correto.",
        ...
        "credits.thanks": "Obrigado por usar",
        "credits.intro": "Desenvolvido para o Apple Swift Student Challenge. O EcoScanner usa recursos abertos e contribuições da comunidade. Agradecimentos especiais às fontes abaixo.",
        ...
        "credits.dataset.1.title": "Garbage Classification v2",
        "credits.dataset.1.detail": "Kaggle dataset por sumn2u",
        "credits.dataset.2.title": "Garbage Classification",
        "credits.dataset.2.detail": "Kaggle dataset por asdasdasasdas",
        "credits.dataset.3.title": "Garbage Classification",
        "credits.dataset.3.detail": "Kaggle dataset por mostafaabla",
        "credits.dataset.4.title": "Plastic Paper Garbage Bag",
        "credits.dataset.4.detail": "Kaggle dataset por vencerlanz09",
        "credits.dataset.5.title": "Trash Type Image Dataset",
        "credits.dataset.5.detail": "Kaggle dataset por farzadnekouei",
        "credits.dataset.6.title": "Garbage Classification",
        "credits.dataset.6.detail": "Kaggle dataset por hassnainzaidi",
        "credits.dataset.7.title": "Tipe Webscraping",
        "credits.dataset.7.detail": "Kaggle dataset por manonstr",
