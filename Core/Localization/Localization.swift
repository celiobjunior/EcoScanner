...
enum LocalizationStore {
    ...
    static let en: [String: String] = [
        ...
        "credits.dataset.three.title": "Garbage Classification Dataset (Zenodo)",
        "credits.dataset.three.detail": "Dataset source and references.",
    ...
    static let ptBR: [String: String] = [
        ...
        "credits.dataset.three.title": "Garbage Classification Dataset (Zenodo)",
        "credits.dataset.three.detail": "Fonte e referências do dataset.",
